<script>
    ...
    function createSquares() {
        ...
        stateGroup.append('text')
                ...
                .attr('x', 0)
                .attr('y', -10)
                .text('Dem. Joe Biden - 306 votes |  Rep. Donald Trump - 232 votes')
                .attr('fill', 'black')
                .style('display', 'block')
...
<div class="chart-container">
    <div class="map-and-text">
        ...
        <div class="text-box" style="margin-top: {50}px;">
            ...
            <p>Included are the results of the presidential election by state in terms of electoral votes. Highlight over boxes to see the election results for that particular state or sort by candidate to visualize the total electoral votes received for each candidate. If you already sorted and want to see the highlight interactivty previously mentioned, click unsort first.<br> <br> Now, it should be more clear that Joe Biden won the election due to winning 25 states that had a combined electoral vote count greater than the states that Donald Trump won. Even though Donald Trump won more counties and the same number of states as Joe Biden, taking into account population is the difference. Democrat Joe Biden had better success in more urban counties and states, which have a higher population and, thus, more electoral votes. Republican Donald Trump, on the other hand, had his success in less populous rural counties and states, which have less electoral votes due to having a lower state population. While the 2020 presidential election results can be confusing when looking at the state-level and county-level representations, factoring in how the presidential election handles state populations efficiently conveys how Joe Biden won the election. <br> <br><span style="font-weight: bold;">Now, let us prove the claim that it is a reocurring trend that Democrats do better in urban areas and Republicans do better in more rural counties and states.</span></p>
        </div>
    </div>
</div>
