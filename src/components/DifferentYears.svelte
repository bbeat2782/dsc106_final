...
<div class="text-box" style="margin: 0px auto;">
    ...
    <p>Visualized are the presidential election results from 2000 to 2020. The trend of Republican candidates doing better in rural areas and Democratic candidates in urban areas is made apparent when comparing the 2020 election results to other elections. Since there are more rural counties and states in the U.S., the county-level and state-level election results make it appear that the Republican candidate should win every election by a landslide. But, as proved prior, this is not the case because of the electoral college voting system, where state population is taken into account. Factoring in county and state population can explain the following scenarios: the Democratic candidate receiving the majority of votes in states with majority Republican-leaning counties and Democratic candidates winning fewer states but receiving more electoral votes (and, thus, winning the election). This leads to closer election results than insinuated by the county-level and state-level depictions. Now, you can critically look at these maps and understand how the election outcome is determined.</p>
</div>
<div class="slider">
