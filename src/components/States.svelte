...
<div class="chart-container">
  <div class="map-and-text">
    ...
    <div class="text-box" style="margin-top: {50}px;">
      ...
      <p>
      In presidential elections, votes are first counted by state and then overall. Shown is the overall and state breakdown of the 2020 presidential election between Democrat Joe Biden and Republican Donald Trump. Democrats are associated with the color <span style="color: blue; font-weight:bold;">blue</span> and Republicans with the color <span style="color: red; font-weight:bold;">red</span>, which is utilized in color-coding the state results and the overall results. You can also highlight over different states to see the winner of that state. As seen, Joe Biden and Donald Trump both won 25 states, but, evident from the bar chart above the map, Joe Biden won the election. <span style="font-weight: bold;">How did this happen?</span>
      </p>
    </div>
  </div>
